...
import com.lawencon.jobportalspringboot.error.ConstraintValidationException;
import com.lawencon.jobportalspringboot.model.response.WebResponse;
import com.lawencon.jobportalspringboot.validation.ValidationErrorMapper;
...
@RestControllerAdvice("com.lawencon")
@Slf4j
...
//  public WebResponse<Object> ossException(OSSException e) {
//    log.warn(OSSException.class.getName(), e);
//    return WebResponse.builder().code(HttpStatus.INTERNAL_SERVER_ERROR.value())
//        .status(HttpStatus.INTERNAL_SERVER_ERROR.name()).build();
//  }
//
...
//  public WebResponse<Object> clientException(ClientException e) {
